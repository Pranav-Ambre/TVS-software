      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="inline-flex items-center gap-1 bg-amber-50 text-amber-800 text-xs font-semibold px-2.5 py-1 rounded-full border border-amber-200">
        ...
        <div className="flex items-center gap-2">
          <div className="bg-blue-50 text-blue-800 border border-blue-200 px-3 py-1.5 rounded-xl text-xs font-semibold flex items-center gap-2">
            <Activity className="w-3.5 h-3.5 text-blue-600" />
            <span>Multi-Entity Divergence Engine Active</span>
          </div>
        </div>
      </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
              ...
              <div className="space-y-1.5 text-xs pt-1">
                <div className="flex justify-between text-[11px] font-semibold text-slate-600">
                  <span>Traditional View: Clean Profile</span>
                  <span>EERIS View: Network Risk</span>
                </div>
