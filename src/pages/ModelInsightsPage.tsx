  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Model Insights &amp; Portfolio Impact</h1>
          <p className="text-sm text-slate-500 mt-1">
            Explainable prototype weight adjustments, feedback loops, and customer experience trade-offs.
          </p>
        </div>
